...
BATCH_SIZE = 128    #单次学习取记录数 # default 128
EPS_START = 0.8
EPS_END = 0.1
EPS_DECAY = 5000
...
def application():
    ...
    d3qn_app.local_net.clear_memorycell()
    for uav in env.uavs:
        uav.strict_flag = 1
    env.render(1)
    uav_x = []
...
if __name__ == '__main__':
    ...
    if train_flag:
        ...
        # train('_5_5_3_DQN_connectivity_3cen_nTU_obv3')
        train_distributed('DRQN_EveryStep')
    ...
    if perf_test:
        ...
        for i in range(3):
            ...
            # pathname_localnet = 'localnet_5_5_3_DQN_3cen_nTU_obv3.pth'
            pathname_localnet = 'localnetDRQN_EveryStep'+ str(i) + '.pth'
