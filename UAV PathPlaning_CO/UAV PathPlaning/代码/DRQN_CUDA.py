...
if __name__ == '__main__':
    ...
    for n in range(3, 4, 2):
        modelname = 'DRQN_CO_06012025_1' + str(n) + 'UAVs'
        if train_flag:
        ...
        if perf_test:
            ...
            for i in range(3, 9, 1):
                ...
                _, _, successrate, TUserverate, step_done, avgtime, collision_rate, equality = performance_test_distributed(d3qn_app, num_test, n_TU=15, n_dyob=i, n_ob=5, n_UAV=n)
            ...
            p = 'DRQN_CO_06012025_1_T2_OB_' + str(n) + 'UAVs'
