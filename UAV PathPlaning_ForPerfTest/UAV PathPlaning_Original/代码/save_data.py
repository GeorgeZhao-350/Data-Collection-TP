...
# 动态障碍物数量测试
    plt.figure(1)
    x = np.arange(3, 9, 1)
    l1 = read('DRQN_20092024_T1_successrate.txt', 6)
    l2 = read('D3QN_24092024_T1_OB_successrate.txt', 6)
    l3 = read('D3QN_28092024_T4_OB_successrate.txt', 6)
    # l4 = read('D3QN_09012025_TU_T1_successrate.txt', 6)
    plt.ylim(0.4, 1)
    ...
    plt.figure(2)
    x = np.arange(3, 9, 1)
    l1 = read('DRQN_20092024_T1_avgtime.txt', 6)
    l2 = read('D3QN_24092024_T1_OB_avgtime.txt', 6)
    l3 = read('D3QN_28092024_T4_OB_avgtime.txt', 6)
    # l4 = read('D3QN_09012025_TU_T1_avgtime.txt', 6)
    plt.plot(x, l1, 'o-', color='r', label='DRQN')
    ...
    plt.figure(3)
    x = np.arange(3, 9, 1)
    l1 = read('DRQN_20092024_T1_TUserverate.txt', 6)
    l2 = read('D3QN_24092024_T1_OB_TUserverate.txt', 6)
    l3 = read('D3QN_28092024_T4_OB_TUserverate.txt', 6)
    # l4 = read('D3QN_09012025_TU_T1_TUserverate.txt', 6)
    plt.ylim(0.9, 1)
    plt.plot(x, l1, 'o-', color='r', label='DRQN')
    # plt.plot(x, l4, 'o-', color='m', label='DDQN-[22]')
    plt.plot(x, l2, 'o-', color='g', label='D3QN')
    ...
    # l4 = read('D3QN_09012025_TU_T1_collision_rate.txt', 6)
    plt.ylim(0, 0.1)
    plt.plot(x, l1, 'o-', color='r', label='DRQN')
    # plt.plot(x, l4, 'o-', color='m', label='DDQN-[22]')
    plt.plot(x, l2, 'o-', color='g', label='D3QN')
