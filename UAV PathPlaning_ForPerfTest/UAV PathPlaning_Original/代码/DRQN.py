...
def save_fig(file_name, reward_list, reward_test_avg, successrate, TUserverate, allsuccessrate, stepdone_avg):
    ...
    try:
        filepath="D:\DRQN_Data\DRQN_Data\DRQN_2UAVs"
    ...
    if perf_test:
        ...
        for i, var in enumerate(test_var):
            for n, seed in enumerate(seed_nums):
                ...
                _, _, successrate, TUserverate, step_done, avgtime, collision_rate, timeout_rate = performance_test_distributed(d3qn_app, num_test, n_UAV=n_uav, n_TU=50, n_dyob=var, n_ob=10)
        ...
        p = 'A_Result\DRQN_OB10_DOB10_TU50_Small_Large'  # DRQN_21102024_T1_TU
