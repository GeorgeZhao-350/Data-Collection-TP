...
class ICM():
    ...
    def update(self, batch_state, batch_next_state, batch_action):
        ...
        fwd = self.model.forward(f_state, batch_action.unsqueeze(0))
...
def application():
    ...
    for i in range(env.n_uav):
        ...
        pathname_net='localnetDRQN'+ str(i) + '.pth'
...
if __name__ == '__main__':
    ...
    if perf_test:
        ...
        for i in range(3):
            d3qn_app.append(DRQN())
            # pathname_localnet = 'localnet_5_5_3_DQN_3cen_nTU_obv3.pth'
            pathname_localnet = 'localnetDRQN_ICM'+ str(i) + '.pth'
