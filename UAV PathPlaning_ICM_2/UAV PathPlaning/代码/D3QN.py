...
def performance_test_multiuavs(network, num_test, n_UAV=3, n_TU=15, n_dyob=5, n_ob=5):
    ...
    return reward_test, successrate, allsuccessrate, TUserverate, step_done, time_avg, collision_rate, uav_collision_rate
...
if __name__ == '__main__':
    ...
    if perf_test:
        ...
        for i in range(6, 25, 3):
            ...
            _, _, successrate, TUserverate, step_done, avgtime, collision_rate, uav_collision_rate = performance_test_multiuavs(
                d3qn_app, num_test, n_UAV=3, n_TU=i, n_dyob=5, n_ob=5)
            ...
            UAV_neig_collision.append(uav_collision_rate)
            print(
                '\nsuccess rate:  %.3f\tTU serve rate:  %.3f\taverage step: %d\taverage time: %d\tcollision rate: %.3f\tUAV collision rate: %.3f\n' % (
                successrate, TUserverate, step_done, avgtime, collision_rate, uav_collision_rate))

        p = 'D3QN_forICM_17112024_TU_T1'
        ...
        # save(p + '_uav_collision_rate.txt', UAV_neig_collision)
