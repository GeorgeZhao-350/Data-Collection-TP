...
class DRQN():
    ...
    def sample(self):
        ...
        batch_terminal = torch.zeros((BATCH_SIZE, 1), dtype=torch.int64)
        ...
        for i in range(BATCH_SIZE):
            ...
            batch_terminal[i] = torch.FloatTensor(batch_memory[TIME_LENGTH - 1, NUM_STATES + 2:NUM_STATES + 3])
